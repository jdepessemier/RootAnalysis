public class CorrectedAccession {
	...
	private Double[] NLR = new Double[5];      // Array of Number of Lateral Roots (>1mm)
	...
	public CorrectedAccession(String name,
	...
	public void setNLR(double value, int idx) {
		NLR[idx] = value;
	}
